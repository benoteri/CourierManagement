...
?>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><div align="center"> <br>
        ...
        <tbody><tr>
          <!-- <td class="Partext1" bgcolor="#EEEEEE"><div align="left"><strong>Nairobi Couriers Management System </strong></div></td>
        </tr>
        <tr>
  ...
  <li class="list-group-item px-3 border-0 active" aria-current="true">
    NAIROBI COURIER MANAGEMENT SYSTEM
  </li>
  <li class="list-group-item px-3 border-0" ><a href="add-courier.php">Add Shipment</a></li>
  <li class="list-group-item px-3 border-0"href="login.php"><a href="login.php">Log Out</a></li>
